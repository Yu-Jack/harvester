...
type USBDeviceClaimHandler struct {
	usbDeviceClaim ctlharvesterv1.USBDeviceClaimController
	virtClient     kubecli.KubevirtClient
	lock           *sync.Mutex
	usbDeviceCache ctlharvesterv1.USBDeviceCache
	devicePlugin   map[string]*USBDevicePlugin
}

func (h *USBDeviceClaimHandler) OnUSBDeviceClaimChanged(_ string, usbDeviceClaim *harvesterv1.USBDeviceClaim) (*harvesterv1.USBDeviceClaim, error) {
...
func (h *USBDeviceClaimHandler) OnRemove(_ string, claim *harvesterv1.USBDeviceClaim) (*harvesterv1.USBDeviceClaim, error) {
	if claim == nil {
		return claim, nil
	}
